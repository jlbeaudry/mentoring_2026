...
In 2026, we are trialling a tiered mentoring approach to meet the 
considerable demand from MCRs for mentoring opportunities for themselves. 
In this new approach, a senior researcher mentors a mid-career researcher, 
who in turn mentors an early-career researcher. 

This year, we had 31 pairs in the traditional program alongside 3 triads in 
the pilot program. 
...
the College of Nursing and Health Sciences had a larger percentage of mentors
compared to the percentage of mentees. 
As usual, the College of Medicine and Public Health had the largest 
percentage of mentees in the program, but the numbers were smaller than the last
few years. The 
...
col %>% 
knitr::kable (booktabs = T, linesep = "", format = "latex",
...
# This is the text for the intro to the tabl (see above)
#The table below shows the details of the mentees who were selected to participate in the program.
...
write.csv(col_tee_details_more, here::here("00_data", "paired_data", "col_tee_details_more.csv"), row.names = FALSE)
