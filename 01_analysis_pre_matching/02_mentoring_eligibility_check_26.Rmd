...
eligibility criteria for the program. Below are the screening steps:
  ...
  *  Mentee eligibility: We had
  ...
  `r contract_no_n_tee` applications from people whose contracts will end before November 2026. If their
  Colleges had a mentoring program, I connected them with people in the Colleges who could discuss 
  alternate programs.
...
knitr::kable (booktabs = T, linesep = "",
              ...
              align = 'lcc') %>% 
    add_header_above(c(" " = 1, "Mentors (n = 34)" = 2, "Mentees (n = 32)" = 2)) %>% 
  styler_pdf() 
